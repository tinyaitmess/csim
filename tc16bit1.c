...
#define _COUNT_DIR __inst->COUNT_DIR
...
static void on_update_all(csim_inst_t *inst) { on_update_Update(inst); }
...
/* OC1B register functions */

static void name_OC1B(csim_inst_t *inst, int num, char *__buffer, int size) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    __buffer += sprintf(__buffer, "Output Compare A");
}

static void display_OC1B(csim_inst_t *inst, int num, char *__buffer, int size) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    snprintf(__buffer, size, "%d", __inst->OC1B);
    ;
}

static csim_word_t read_OC1B(csim_inst_t *inst, int num) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    return __inst->OC1B;
}

static csim_word_t get_OC1B(csim_inst_t *inst, int num) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    return __inst->OC1B;
}

static void set_OC1B(csim_inst_t *inst, int num, csim_word_t val) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    if (__inst->OC1B != val) {
        __inst->OC1B = val;
        on_update_all(inst);
...
static void write_OC1B(csim_inst_t *inst, int num, csim_word_t val) {
    tc16bit1_inst_t *__inst = (tc16bit1_inst_t *)inst;
    set_OC1B(inst, num, val);
...
static csim_reg_t regs[] = {
    ...
    {"OC1B",   // name
     ...
     0,        // flags
     CSIM_INT, // signal type
     name_OC1B, display_OC1B, read_OC1B, write_OC1B, get_OC1B, set_OC1B},
    {"TCNT1L", // name
     0x84,     // offset
     1,        // size
     1,        // count
...
static void on_trigger_Update(csim_evt_t *evt) {
    ...
    uint8_t __gliss_9_tcnt1;
    uint32_t __gliss_8_mode_type;
    uint8_t __gliss_7_icr1;
    uint8_t __gliss_6_ocr1b;
    uint8_t __gliss_5_ocr1a;
    uint32_t __gliss_4_top;
    uint32_t __gliss_3_prescaler;
    uint8_t __gliss_2_com1a;
    ...
    __gliss_2_com1a = _field8(_TCCR1A, 7, 6);
    __gliss_3_prescaler = 0;
    __gliss_4_top = 65535LU;
    __gliss_5_ocr1a = ((_OCR1AH << 8) | _OCR1AL);
    __gliss_6_ocr1b = ((_OCR1BH << 8) | _OCR1BL);
    __gliss_7_icr1 = ((_ICR1H << 8) | _ICR1L);
    switch (__gliss_1_cs1) {
    case 5:
        __gliss_3_prescaler = 1024LU;
        break;
    case 4:
        __gliss_3_prescaler = 256LU;
        break;
    case 3:
        __gliss_3_prescaler = 64;
        break;
    case 2:
        __gliss_3_prescaler = 8;
        break;
    case 1:
        __gliss_3_prescaler = 1;
        break;
    }
    __gliss_8_mode_type = 0;
    if ((((uint8_t)(__gliss_0_wgm)) == 0)) {
        __gliss_8_mode_type = 0;
    } else {
        if (((((uint8_t)(__gliss_0_wgm)) == 4) || (((uint8_t)(__gliss_0_wgm)) == 12))) {
            __gliss_8_mode_type = 1;
        } else {
            if ((((((((((uint8_t)(__gliss_0_wgm)) == 1) || (((uint8_t)(__gliss_0_wgm)) == 2)) ||
                     (((uint8_t)(__gliss_0_wgm)) == 3)) ||
                    (((uint8_t)(__gliss_0_wgm)) == 8)) ||
                   (((uint8_t)(__gliss_0_wgm)) == 9)) ||
                  (((uint8_t)(__gliss_0_wgm)) == 10)) ||
                 (((uint8_t)(__gliss_0_wgm)) == 11))) {
                __gliss_8_mode_type = 2;
            } else {
                if ((((((((uint8_t)(__gliss_0_wgm)) == 5) || (((uint8_t)(__gliss_0_wgm)) == 6)) ||
                       (((uint8_t)(__gliss_0_wgm)) == 7)) ||
                      (((uint8_t)(__gliss_0_wgm)) == 14)) ||
                     (((uint8_t)(__gliss_0_wgm)) == 15))) {
                    __gliss_8_mode_type = 3;
                } else
                    __gliss_8_mode_type = 0;
            }
        }
    ...
    case 4:
        __gliss_4_top = ((uint32_t)(__gliss_5_ocr1a));
        break;
    case 15:
        __gliss_4_top = ((uint32_t)(__gliss_5_ocr1a));
        break;
    case 11:
        ...
        break;
    case 12:
        __gliss_4_top = ((uint32_t)(__gliss_7_icr1));
        break;
    case 14:
        __gliss_4_top = ((uint32_t)(__gliss_7_icr1));
        break;
    ...
    __gliss_9_tcnt1 = ((_TCNT1H << 8) | _TCNT1L);
    switch (__gliss_8_mode_type) {
    case 3:
        if ((((uint32_t)(__gliss_9_tcnt1)) == __gliss_4_top)) {
            _COUNT_DIR = ((uint8_t)(0));
            if ((__gliss_4_top == ((uint32_t)(__gliss_5_ocr1a)))) {
                _TIFR1 = _set_field8(_TIFR1, ((uint8_t)(1)), 1, 1);
                switch (__gliss_2_com1a) {
                case 3:
                    _OC1A = ((uint8_t)(0));
                    break;
                case 2:
                ...
                if ((__gliss_4_top == ((uint32_t)(__gliss_7_icr1)))) {
                    _TIFR1 = _set_field8(_TIFR1, ((uint8_t)(1)), 5, 5);
                }
            }
        } else {
            if ((((uint32_t)(__gliss_9_tcnt1)) == 0)) {
                _COUNT_DIR = ((uint8_t)(1));
        ...
        if ((((uint32_t)(_COUNT_DIR)) == 1)) {
            __gliss_9_tcnt1 = ((uint8_t)((((uint32_t)(__gliss_9_tcnt1)) + 1)));
        } else
            __gliss_9_tcnt1 = ((uint8_t)((((uint32_t)(__gliss_9_tcnt1)) - 1)));
        break;
    case 2:
        if ((((uint32_t)(__gliss_9_tcnt1)) == __gliss_4_top)) {
            __gliss_9_tcnt1 = ((uint8_t)(0));
            _TIFR1 = _set_field8(_TIFR1, ((uint8_t)(1)), 0, 0);
            if ((__gliss_4_top == ((uint32_t)(__gliss_5_ocr1a)))) {
                _TIFR1 = _set_field8(_TIFR1, ((uint8_t)(1)), 1, 1);
                switch (__gliss_2_com1a) {
    ...
    _TCNT1H = (__gliss_9_tcnt1 >> 8);
    _TCNT1L = ((uint8_t)((((uint32_t)(__gliss_9_tcnt1)) & 255LU)));
    csim_evt_t *Update = malloc(sizeof(csim_evt_t));
    Update->date = __now + __gliss_3_prescaler;
    Update->inst = inst;
